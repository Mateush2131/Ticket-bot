...
# API казино
CASINO_API_URL = os.getenv("CASINO_API_URL", "https://catswill.casino/api/bot")
CASINO_API_TOKEN = os.getenv("CASINO_API_TOKEN", "")
CASINO_API_ENABLED = os.getenv("CASINO_API_ENABLED", "true").lower() == "true"
